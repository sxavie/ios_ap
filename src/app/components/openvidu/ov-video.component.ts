...
@Component({
    selector: 'ov-video',
    template: '<video #videoElement poster="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" style="width: 100%; border-radius:8px;"></video>'
})
